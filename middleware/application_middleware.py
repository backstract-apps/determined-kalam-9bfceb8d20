...
async def auth_package_middleware(request: Request) -> Dict[str, Any]:
    ...
    Generated from middleware ID: mid_f56631170a0c43578bc99ba25861ddf6
    """
    try:
        ...
        auth_package_secret_key = """vI0ddZJ-mrUJi9TYiV1rXQNMzX2EtmjCV_LJU1SEwl4="""
...
async def cors_middleware(request: Request) -> Dict[str, Any]:
    """
    CORS Middleware
    Generated from middleware ID: mid_359a064cf570423e872befdd76515ed2
    """
    try:
